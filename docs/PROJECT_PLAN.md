...
This project asks what level of security would make those choices realistically available. Food, housing, healthcare, and other essentials matter both as human needs and as conditions that affect people's ability to direct their lives. The content and financing of that security remain open questions.
...
This concern extends to governments, corporations, unions, political movements, professional bodies, and institutions created by reform itself. Moving authority to a different institution does not establish that the authority will be used well.
...
| --- | --- |
| Economic security | Give people enough stability to exercise meaningful choice. |
| Personal freedom and competitive markets | Preserve different ambitions, experimentation, enterprise, and outcomes. |
| Broader productive ownership | Examine how participation in future growth can support independence and opportunity. |
| Contestable power and distributed governance | Limit the conversion of success or public authority into lasting domination. |
| Continuous evaluation and correction | Allow failures to be addressed and future generations to choose better arrangements. |
| A survivable transition | Protect people and essential capacity while changes are developed and tested. |
...
The working approach is to introduce changes incrementally, reuse existing capacity where possible, test alternatives before retiring essential arrangements, and make intermediate stages useful even if the wider transformation stops. Parallel operation may be necessary, but duplicating entire systems indefinitely would impose costs of its own.
...
- Compensation and conditions: examine salary, benefits, wage parity, hours, caregiving, relocation, part-time equivalence, and representation. Paid service remains a recommendation pending an explicit decision on terms.
- Placement: define useful public benefit, approved employers, participant choice, local and remote work, supervision, and maximum waiting time. Specify relief when government cannot provide suitable work.
- Disability and hardship: match duties to actual capability; examine accommodations, episodic conditions, changed circumstances, caring duties, postponement, and appeals. Resolve genuine inability without presuming that study proves sustained employment capacity.
- Withdrawal and breach: compare transfer, proportionate repayment, hardship relief, and government breach. Assess whether a nominally voluntary contract preserves practical exit options. Obtain qualified legal review before relying on enforceability.
- Equity and additional value: measure burden by income, disability, geography, age, and family status. Account for participants who would have served anyway, displaced regular jobs, and supervision costs.
...
For each cohort and year estimate education funding, salary and benefits, administration, accommodation, supervision, facilities, and financing costs. Subtract only justified budget savings or receipts. Report gross and net costs. Public service output is not automatically spendable revenue.

Vary enrollment, completion, placement delays, wage growth, service length, supervisory load, withdrawal, and retention. State discount rates and inflation assumptions. Report ranges, opportunity costs, and sensitivity to uncertain inputs rather than a single confident projection.

Measure the purposes directly:

- Economic security: resources after essential costs, hardship, arrears, access delays, and benefit cliffs.
- Practical freedom: genuine ability to change jobs or direction, unwanted placements, exit burdens, intrusive conditions, and complaint outcomes.
- Opportunity and ownership: participation, access, concentration, investment risk, and control over productive assets.
- Public capacity: additional useful service relative to a credible baseline, adjusted for displacement and supervision.
...
- Noncompletion or changed capacity: is the remaining burden proportionate and feasible, with appropriate appeal and hardship treatment?
- Worker displacement or wage suppression: does useful capacity still increase after those effects are counted?
- Provider price inflation: does education support expand access or merely increase prices? Test quality controls and provider incentives.
- Capture of oversight or ownership funds: can people detect, challenge, and reverse control by entrenched interests?
- Supply shortages and scale: do expanding demand, scarce labor, or infrastructure limits erase benefits?
- Security with excessive control: does a floor or service program give institutions intrusive authority over recipients?
- Wealth reconcentration: do new ownership arrangements reproduce the power cycle the framework seeks to address?
- Indefinite transition: do temporary institutions become permanent interests, or does caution prevent correction of known harm?
...
Open the inquiry to outside reviewers through CONTRIBUTING.md and GOVERNANCE.md. Contributors can challenge claims, offer evidence or lived experience with clear scope, and propose changes without coding or formal credentials. Review must assess the complete purpose, evidence, feasibility, distribution, freedom and power, and alternatives.

The initial process is a versioned proposal, substantive review, revision, an advisory ballot on a frozen text, a documented owner decision, and integration through a reviewed pull request. Seven-day review and voting windows and a target of three non-author ballots plus an independent review are provisional trial defaults. Record low turnout and disputed ballots honestly. Votes do not establish empirical truth or automatically approve a merge. Existing owner authority remains until explicitly changed.

Retain reasons, dissent, exclusions, interests, proposal versions, final approval, and the merge commit in the decision record. Update all affected parts of the living project and regenerate its editions. New substantive text after a vote needs renewed review. Plain editorial maintenance may use a shorter review path. Contributors must have permission to publish submitted material; a general project license remains unresolved.

This initial governance design is itself open to review. Binding voter authority, eligibility, delegation, and stronger technical enforcement require explicit decisions. No ballot automation or branch protection has been installed by the documentation update. The first review checkpoint is after three completed proposals or 30 days of active participation, whichever occurs first.
