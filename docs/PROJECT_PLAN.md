...
- Compensation and conditions: examine salary, benefits, wage parity, hours, caregiving, relocation, part-time equivalence, and representation. Paid service remains a recommendation pending contributor adoption of its terms.
...
The process is a versioned proposal, substantive review, revision, a contributor ballot on a frozen text, a recorded result, and faithful integration through a reviewed pull request. People qualify through traceable project work, including proposals, reviews, explained evidence, relevant lived experience, analysis, and editing. A contribution need not be accepted or agree with the current position. The founder has no unilateral veto; each contributor has one vote.
