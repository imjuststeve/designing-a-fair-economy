...
| 4 — Challenge | Failure scenarios, independent review where available, retained dissent |
| 5 — Synthesis | Revised framework, source appendix, decision recommendations |
| 6 — Conditional pilot design | Limited intervention with evaluation, protections, funding, and shutdown plan |

These are planned phases, not completed milestones. A United States civilian case study is a proposed starting boundary, not an adopted geographic restriction. A successful local example would not establish that the same design transfers unchanged to other societies.
